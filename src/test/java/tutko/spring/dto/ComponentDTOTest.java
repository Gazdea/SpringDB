...
class ComponentDTOTest {
    ...
    public void testGetComponentId() {
        ...
        assertEquals(1, componentDTO.getComponentId());
    }
    ...
    public void testSetters() {
        ...
        when(componentDTO.setComponentId(1)).thenReturn(componentDTO);
        ...
        assertEquals(componentDTO, componentDTO.setComponentId(1));
